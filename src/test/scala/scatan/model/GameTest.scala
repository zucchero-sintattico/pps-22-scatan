...
class GameTest extends BaseTest:
  ...
  it should "have an empty development cards map initially" in {
    val game: Game = Game(players = threePlayers)
    game.developmentCardsOfPlayers should be(DevelopmentCardsOfPlayers.empty(threePlayers))
  }
  ...
  it should "allow to assign development cards" in {
    ...
    game3.developmentCardsOfPlayers(player1) should be(
    ...
    val game4 = game3.assignDevelopmentCard(player2, DevelopmentCard(DevelopmentType.Knight))
    game4.developmentCardsOfPlayers(player1) should be(
      Seq(DevelopmentCard(DevelopmentType.Knight), DevelopmentCard(DevelopmentType.Knight))
    )
    game4.developmentCardsOfPlayers(player2) should be(Seq(DevelopmentCard(DevelopmentType.Knight)))
  }
